<div class="left-side col-md-2" style="visibility: visible">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="ndawoni">
            ...
            <li><a href="<?php echo URLROOT . '/freeStateJobs/ndawoni/' . $location->ndawoni_slug; ?>"><?php echo $location->ndawoni; ?> (<?php echo $location->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <div class="province-header">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="onjani">
            ...
            <li><a href="<?php echo URLROOT . '/freeStateJobs/onjani/' . $onjani->onjani_slug; ?>"><?php echo $onjani->msebenzi_onjani; ?> (<?php echo $onjani->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <div class="province-header">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="imfundo">
            ...
            <li><a href="<?php echo URLROOT . '/freeStateJobs/mfundo/' . $mfundo->mfundo_slug; ?>"><?php echo $mfundo->mfundo; ?> (<?php echo $mfundo->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>   
    <div class="province-header">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="owantoni">
            ...
            <li><a href="<?php echo URLROOT . '/freeStateJobs/ngowantoni/' . $ngowantoni->ngowantoni_slug; ?>"><?php echo $ngowantoni->ngowantoni; ?> (<?php echo $ngowantoni->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <div class="province-header">
