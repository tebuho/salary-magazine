<div class="left-side col-md-2" style="visibility: visible">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="job_location">
            ...
            <li><a href="<?php echo URLROOT . '/northWestJobs/job_location/' . $job_location->job_location_slug; ?>"><?php echo $job_location->job_location; ?> (<?php echo $job_location->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <div class="province-header">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="owantoni">
            ...
            <li><a href="<?php echo URLROOT . '/northWestJobs/category/' . $job_category->job_category_slug; ?>"><?php echo $job_category->job_category; ?> (<?php echo $job_category->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <div class="province-header">
