<div class="left-side col-md-2" style="visibility: visible">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="job_location">
            ...
            <li><a href="<?php echo URLROOT . '/mpumalangaJobs/job_location/' . $job_location->job_location_slug; ?>"><?php echo $job_location->job_location; ?> (<?php echo $job_location->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <div class="province-header">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="onjani">
            ...
            <li><a href="<?php echo URLROOT . '/mpumalangaJobs/onjani/' . $onjani->job_type_slug; ?>"><?php echo $onjani->job_type; ?> (<?php echo $onjani->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <div class="province-header">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="ijob_education">
            ...
            <li><a href="<?php echo URLROOT . '/mpumalangaJobs/job_education/' . $job_education->job_education_slug; ?>"><?php echo $job_education->job_education; ?> (<?php echo $job_education->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>   
    <div class="province-header">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="experience">
            ...
            <li><a href="<?php echo URLROOT . '/mpumalangaJobs/experience/' . $experience->experience_slug; ?>"><?php echo $experience->experience; ?> (<?php echo $experience->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <div class="province-header">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="owantoni">
            ...
            <li><a href="<?php echo URLROOT . '/mpumalangaJobs/category/' . $job_category->job_category_slug; ?>"><?php echo $job_category->job_category; ?> (<?php echo $job_category->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <div class="province-header">
