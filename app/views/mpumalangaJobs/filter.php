<div class="left-side col-md-2" style="visibility: visible">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="ndawoni">
            ...
            <li><a href="<?php echo URLROOT . '/mpumalangaJobs/ndawoni/' . $job_location->job_location_slug; ?>"><?php echo $job_location->ndawoni; ?> (<?php echo $job_location->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <div class="province-header">
    ...
    <div class="province-container filter-container">
        <ul class="province filter multi-collapse collapse" id="owantoni">
            ...
            <li><a href="<?php echo URLROOT . '/mpumalangaJobs/category/' . $category->job_category_slug; ?>"><?php echo $category->category; ?> (<?php echo $category->count; ?>)</a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <div class="province-header">
