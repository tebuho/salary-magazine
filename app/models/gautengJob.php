...
class gautengJob
{
    ...
    public function getImisebenziByLocation($location)
    {
        $this->db->query(
            ...
            WHERE province = "Gauteng" AND closing_date >=  now() AND ndawoni_slug = :ndawoni
            OR province = "Gauteng" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function filterImisebenziByType()
    {
        $this->db->query(
            ...
            WHERE province = "Gauteng" AND closing_date >=  now() AND ngowantoni_slug != :empty
            OR province = "Gauteng" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function getImisebenziByType($type)
    {
        $this->db->query(
            ...
            WHERE province = "Gauteng" AND closing_date >=  now() AND ngowantoni_slug = :ngowantoni
            OR province = "Gauteng" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function getImisebenziByOnjani($onjani)
    {
        $this->db->query(
            ...
            WHERE province = "Gauteng" AND closing_date >=  now() AND onjani_slug = :onjani
            OR province = "Gauteng" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function getImisebenziByMfundo($education)
    {
        $this->db->query(
            ...
            WHERE province = "Gauteng" AND closing_date >=  now() AND mfundo_slug = :mfundo
            OR province = "Gauteng" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
