...
class easternCapeJob
{
    ...
    public function getImisebenziByLocation($location)
    {
        $this->db->query(
            ...
            WHERE province = "Eastern Cape" AND closing_date >=  now() AND ndawoni_slug = :ndawoni
            OR province = "Eastern Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function getImisebenziByType($type)
    {
        $this->db->query(
            ...
            WHERE province = "Eastern Cape" AND closing_date >=  now() AND ngowantoni_slug = :ngowantoni
            OR province = "Eastern Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function paginateImisebenziByType($data)
    {
        $this->db->query(
            ...
            WHERE province = 'Eastern Cape' AND ngowantoni = :ngowantoni
            AND closing_date = '0000-00-00' AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function getImisebenziByEmployer($employer)
    {
        $this->db->query(
            ...
            WHERE province = "Eastern Cape" AND closing_date >=  now() AND employer_slug = :employer
            OR province = "Eastern Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function getImisebenziByExperience($exp)
    {
        $this->db->query(
            ...
            WHERE province = "Eastern Cape" AND closing_date >=  now() AND experience_slug = :experience
            OR province = "Eastern Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    {
        $this->db->query(
            'SELECT msebenzi_onjani, onjani_slug, ngowantoni, closing_date, label, slug, requirements, id_yomntu, `image`
            FROM imisebenzi
            
            WHERE province = "Eastern Cape" AND closing_date >=  now() AND onjani_slug = :onjani
            OR province = "Eastern Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function paginateImisebenziNgoBunjani($data)
    {
        $this->db->query(
            "SELECT msebenzi_onjani, ngowantoni, gama_le_company, job_title, province_slug, ndawoni, slug, id_yomntu, purpose, image,
             ...
             END AS 'closingDate'
             FROM imisebenzi
            WHERE province = 'Eastern Cape' AND msebenzi_onjani = :onjani
            AND closing_date = '0000-00-00' AND timestampdiff(day, created_at, now()) < 7
    ...
    public function getImisebenziByMfundo($education)
    {
        $this->db->query(
            ...
            WHERE province = "Eastern Cape" AND closing_date >=  now() AND mfundo_slug = :mfundo
            OR province = "Eastern Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function paginateImisebenziNgeMfundo($data)
    {
        $this->db->query(
            "SELECT msebenzi_onjani, ngowantoni, gama_le_company, job_title, province_slug, ndawoni, slug, id_yomntu, purpose, image,
             ...
             END AS 'closingDate'
             FROM imisebenzi
            WHERE province = 'Eastern Cape' AND mfundo = :mfundo
            AND closing_date = '0000-00-00' AND timestampdiff(day, created_at, now()) <= 7
            OR province = 'Eastern Cape'
    ...
    public function searchImisebenzi($data)
    {
        $this->db->query(
            ...
            WHERE province = "Eastern Cape" AND gama_le_company LIKE :search AND closing_date >=  now()
            
            OR province = "Eastern Cape" AND gama_le_company LIKE :search
            AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) < 7
            
            OR province = "Eastern Cape" AND ndawoni LIKE :search AND closing_date >=  now() 
            
            OR province = "Eastern Cape" AND ndawoni LIKE :search
            AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) < 7
            
            OR province = "Eastern Cape" AND job_title LIKE :search AND closing_date >=  now()
            
            OR province = "Eastern Cape" AND job_title LIKE :search
            AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) < 7
            
            OR province = "Eastern Cape" AND ngowantoni LIKE :search AND closing_date >=  now()
            
            OR province = "Eastern Cape" AND ngowantoni LIKE :search
            AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) < 7
            
            OR province = "Eastern Cape" AND mfundo LIKE :search AND closing_date >=  now()
            
            OR province = "Eastern Cape" AND mfundo LIKE :search
            AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) < 7
            
            OR province = "Eastern Cape" AND responsibilities LIKE :search AND closing_date >=  now()
