...
class westernCapeJob
{
    ...
    public function paginateImisebenziByEmployer($data)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND gama_le_company = :employer
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, created_at, now()) <= 7
            
            OR province = "Western Cape"
            AND job_closing_date >= :namhlanje AND gama_le_company = :employer
    ...
    public function searchImisebenzi($data)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND gama_le_company LIKE :search AND job_closing_date >=  CURDATE()
            
            OR province = "Western Cape" AND gama_le_company LIKE :search
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, created_at, now()) <= 7
            
            OR province = "Western Cape" AND ndawoni LIKE :search AND job_closing_date >=  now() 
