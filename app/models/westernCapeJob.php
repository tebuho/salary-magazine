...
class westernCapeJob
{
    ...
    public function filterImisebenziByType()
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND closing_date >=  now() AND job_category_slug != :empty
            OR province = "Western Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function getImisebenziByType($type)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND closing_date >=  now() AND job_category_slug = :ngowantoni
            OR province = "Western Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function getImisebenziByOnjani($onjani)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND closing_date >=  now() AND job_type_slug = :onjani
            OR province = "Western Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
