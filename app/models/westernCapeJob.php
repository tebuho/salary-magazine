...
class westernCapeJob
{
    ...
    public function paginateImisebenzi($data)
    {
        $this->db->query(
            'SELECT job_type, category, job_employer, job_title, province_slug, job_location, slug, user_id, purpose, image,
             ...
             END AS "closingDate",
             CASE province_slug
                WHEN "nationwide" THEN "westernCapeJobs"
                ELSE "westernCapeJobs"
    ...
    public function filterImisebenziByType()
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND job_closing_date >=  now() AND job_category_slug != :empty
            OR province = "Western Cape" AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
    ...
    public function getImisebenziByType($type)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND job_closing_date >=  now() AND job_category_slug = :category
            OR province = "Western Cape" AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
    ...
    public function paginateImisebenziByType($data)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND category = :category
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
    ...
    public function getImisebenziByEmployer($employer)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND job_closing_date >=  now() AND employer_slug = :employer
            OR province = "Western Cape" AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
    ...
    public function paginateImisebenziByEmployer($data)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND job_employer = :employer
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
            
            OR province = "Western Cape"
            AND job_closing_date >= :namhlanje AND job_employer = :employer
    ...
    public function getImisebenziByOnjani($onjani)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND job_closing_date >=  now() AND job_type_slug = :onjani
            OR province = "Western Cape" AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
    ...
    public function paginateImisebenziNgoBunjani($data)
    {
        $this->db->query(
            'SELECT job_type, category, job_employer, job_title, province_slug, job_location, slug, user_id, purpose, image,
             ...
             END AS "closingDate"
             FROM imisebenzi
            WHERE province = "Western Cape" AND job_type = :onjani
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
    ...
    public function searchImisebenzi($data)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND job_employer LIKE :search AND job_closing_date >=  CURDATE()
            
            OR province = "Western Cape" AND job_employer LIKE :search
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
            
            OR province = "Western Cape" AND job_location LIKE :search AND job_closing_date >=  now() 
            
            OR province = "Western Cape" AND job_location LIKE :search
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
            
            OR province = "Western Cape" AND job_title LIKE :search AND job_closing_date >=  now()
            
            OR province = "Western Cape" AND job_title LIKE :search
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
            
            OR province = "Western Cape" AND category LIKE :search AND job_closing_date >=  now()
            
            OR province = "Western Cape" AND category LIKE :search
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
            
            OR province = "Western Cape" AND job_education LIKE :search AND job_closing_date >=  now()
            
            OR province = "Western Cape" AND job_education LIKE :search
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
            
            OR province = "Western Cape" AND job_responsibilities LIKE :search AND job_closing_date >=  now()
            
            OR province = "Western Cape" AND job_responsibilities LIKE :search
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
            ...
            OR province = "Western Cape" AND job_requirements LIKE :search
            AND job_closing_date >=  now()
