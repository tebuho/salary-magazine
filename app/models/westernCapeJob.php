...
class westernCapeJob
{
    ...
    public function filterImisebenziByType()
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND closing_date >=  now() AND ngowantoni_slug != :empty
            OR province = "Western Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function getImisebenziByType($type)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND closing_date >=  now() AND ngowantoni_slug = :ngowantoni
            OR province = "Western Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function paginateImisebenziByType($data)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND ngowantoni = :ngowantoni
            AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function getImisebenziByEmployer($employer)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND closing_date >=  now() AND employer_slug = :employer
            OR province = "Western Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function paginateImisebenziByEmployer($data)
    {
        $this->db->query(
            ...
            OR province = "Western Cape"
            AND closing_date >= :namhlanje AND gama_le_company = :employer
    ...
    public function getImisebenziByOnjani($onjani)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND closing_date >=  now() AND onjani_slug = :onjani
            OR province = "Western Cape" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function paginateImisebenziNgoBunjani($data)
    {
        $this->db->query(
            'SELECT msebenzi_onjani, ngowantoni, gama_le_company, job_title, province_slug, ndawoni, slug, id_yomntu, purpose, image,
             ...
             END AS "closingDate"
             FROM imisebenzi
            WHERE province = "Western Cape" AND msebenzi_onjani = :onjani
            AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
    ...
    public function searchImisebenzi($data)
    {
        $this->db->query(
            ...
            WHERE province = "Western Cape" AND gama_le_company LIKE :search AND closing_date >=  CURDATE()
            
            OR province = "Western Cape" AND gama_le_company LIKE :search
            AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
            
            OR province = "Western Cape" AND ndawoni LIKE :search AND closing_date >=  now() 
            
            OR province = "Western Cape" AND ndawoni LIKE :search
            AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
            
            OR province = "Western Cape" AND job_title LIKE :search AND closing_date >=  now()
            
            OR province = "Western Cape" AND job_title LIKE :search
            AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
            
            OR province = "Western Cape" AND ngowantoni LIKE :search AND closing_date >=  now()
            
            OR province = "Western Cape" AND ngowantoni LIKE :search
            AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
            
            OR province = "Western Cape" AND mfundo LIKE :search AND closing_date >=  now()
            
            OR province = "Western Cape" AND mfundo LIKE :search
            AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, now()) <= 7
            
            OR province = "Western Cape" AND responsibilities LIKE :search AND closing_date >=  now()
