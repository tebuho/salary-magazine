...
class northWestJob
{
    ...
    {
        $this->db->query(
            "SELECT COUNT(*) AS count FROM imisebenzi WHERE job_employer = :job_employer AND job_title = :job_title AND job_location = :job_location"
        );
    ...
    /**
     * Get imisebenzi from the database
     */
    public function getImisebenzi()
    {
        $this->db->query(
            ...
            AND job_closing_date = '1970-01-01' AND timestampdiff(day, job_date_published, :namhlanje) <= 7
    ...
    public function filterImisebenziByLocation()
    {
        $this->db->query(
            ...
            OR province = "North West" AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, :namhlanje) <= 7
            
            OR province = "Nationwide" AND job_closing_date >=  :namhlanje
            OR province = "Nationwide" AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, :namhlanje) <= 7
    ...
    public function getImisebenziByLocation($job_location)
    {
        $this->db->query(
            ...
            WHERE province = "North West" AND job_closing_date >=  :namhlanje AND job_location_slug = :job_location
            OR province = "North West" AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, :namhlanje) <= 7
            AND job_location_slug = :job_location
            
            OR province = "Nationwide" AND job_closing_date >=  :namhlanje AND job_location_slug = :job_location
            OR province = "Nationwide" AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, :namhlanje) <= 7
            AND job_location_slug = :job_location
    ...
    public function paginateImisebenziNgeNdawo($data)
    {
        $this->db->query(
            ...
            END AS 'closingDate'
            FROM imisebenzi
            WHERE province = 'North West' AND job_location = :job_location
            AND job_closing_date = '1970-01-01' AND timestampdiff(day, job_date_published, :namhlanje) <= 7
            
            OR province = 'North West'
            AND job_closing_date >= :namhlanje AND job_location = :job_location
    ...
    public function filterImisebenziByEmployer()
    {
        $this->db->query(
            ...
            OR province = "North West" AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) <= 7
    ...
    public function paginateImisebenziByEmployer($data)
    {
        $this->db->query(
            ...
            WHERE province = "North West" AND job_employer = :employer
    ...
    public function searchImisebenzi($data)
    {
        $this->db->query(
            ...
            END AS "closingDate"
            FROM imisebenzi
            WHERE province = "North West" AND job_employer LIKE :search AND job_closing_date >=  now()
            
            OR province = "North West" AND job_employer LIKE :search
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) < 7
            
            OR province = "North West" AND job_location LIKE :search AND job_closing_date >=  now() 
            
            OR province = "North West" AND job_location LIKE :search
            AND job_closing_date = "1970-01-01" AND timestampdiff(day, job_date_published, now()) < 7
