...
class northWestJob
{
    ...
    public function getImisebenziByLocation($location)
    {
        $this->db->query(
            ...
            WHERE province = "North West" AND closing_date >=  :namhlanje AND ndawoni_slug = :ndawoni
            OR province = "North West" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, :namhlanje) <= 7
            AND ndawoni_slug = :ndawoni
            
            OR province = "Nationwide" AND closing_date >=  :namhlanje AND ndawoni_slug = :ndawoni
            OR province = "Nationwide" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, :namhlanje) <= 7
            AND ndawoni_slug = :ndawoni
    ...
    public function getImisebenziByType($type)
    {
        $this->db->query(
            ...
            WHERE province = "North West" AND closing_date >=  :namhlanje AND ngowantoni_slug = :ngowantoni
            OR province = "North West" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, :namhlanje) <= 7
            AND ngowantoni_slug = :ngowantoni
            
            OR province = "Nationwide" AND closing_date >=  :namhlanje AND ngowantoni_slug = :ngowantoni
            OR province = "Nationwide" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, :namhlanje) <= 7
            AND ngowantoni_slug = :ngowantoni
    ...
    public function getImisebenziByOnjani($onjani)
    {
        $this->db->query(
            ...
            WHERE province = "North West" AND closing_date >=  :namhlanje AND onjani_slug = :onjani
            OR province = "North West" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, :namhlanje) <= 7
            AND onjani_slug = :onjani
            
            OR province = "Nationwide" AND closing_date >=  :namhlanje AND onjani_slug = :onjani
            OR province = "Nationwide" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, :namhlanje) <= 7
            AND onjani_slug = :onjani
    ...
    public function getImisebenziByMfundo($education)
    {
        $this->db->query(
            ...
            WHERE province = "North West" AND closing_date >=  :namhlanje AND mfundo_slug = :mfundo
            OR province = "North West" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, :namhlanje) <= 7
            AND mfundo_slug = :mfundo
            
            OR province = "Nationwide" AND closing_date >=  :namhlanje AND mfundo_slug = :mfundo
            OR province = "Nationwide" AND closing_date = "0000-00-00" AND timestampdiff(day, created_at, :namhlanje) <= 7
            AND mfundo_slug = :mfundo
